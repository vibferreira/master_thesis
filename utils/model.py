...
unet_model = smp.Unet(
    ...
    decoder_attention_type = 'scse' # None or'scse' Attention module used in decoder of the model. Available options are **None** and **scse** (https://arxiv.org/abs/1808.08127)
)